...
/**
 * The core PDF API component wrapping the mPDF class with additional enhancements.
 *
...
class Pdf extends Component
{
     ...
     */
    public $cssFile = '@vendor/kartik-v/yii2-mpdf/assets/bootstrap.min.css';
    ...
    /**
     * @var array the mPDF methods to be called in the sequence listed before
